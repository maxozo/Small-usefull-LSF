...
idx1=''
idx2=''
Data1 = pd.read_csv('/lustre/scratch123/hgi/teams/hgi/mo11/tmp/tobi/full_analysis/fetch/results/yascp_inputs/pre_Extra_Metadata.tsv',sep='\t')
...
result.to_csv('/lustre/scratch123/hgi/teams/hgi/mo11/tmp/tobi/full_analysis/fetch/results/yascp_inputs/Extra_Metadata.tsv',sep='\t')
print('Done')
