...
pd.DataFrame(elgh_not_merged_sites).to_csv('/lustre/scratch123/hgi/projects/ukbb_scrna/analysis/mo11/cellsnp_sites_file_expanded/full_elgh_not_merged_sites2.tsv')
