...
for vcf1 in all_vcfs:
    ...
    chr1 = vcf_name
    if chr1=='ukb_imp_chr1_v3':
        os.system(f"bsub -R'select[mem>150000] rusage[mem=150000]' -J ref_first_run{chr1} -n 10 -M 150000 -o {chr1}.o -e {chr1}.e -q normal bash ref_first_run.sh {vcf1} {vcf_name}")
