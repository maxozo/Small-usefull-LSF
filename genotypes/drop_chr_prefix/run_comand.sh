...
# bcftools index no_prefix_chr"$cc"_R2_0.3_MAF_0.0001.vcf.gz
 bcftools view /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/ELGH/release34/merged/cardinal_F2_Subset_v1.bcf.gz | awk '{gsub(/^chr/,""); print}' | awk '{gsub(/ID=chr/,"ID="); print}' > /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/ELGH/release34/merged/cardinal_F2_Subset_v1_no_chr.vcf
