...
# elgh R1 panel
bcftools concat /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/ELGH/release1/topmed_imputed/maf_INFO_filter_coding_no_prefix/cellsnp_panel/*.vcf.gz -Oz -o \
/lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/ELGH/release1/topmed_imputed/maf_INFO_filter_coding_no_prefix/combined_cellsnp_panel/combined_cellsnp_pos.vcf.gz
bcftools index /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/ELGH/release1/topmed_imputed/maf_INFO_filter_coding_no_prefix/combined_cellsnp_panel/combined_cellsnp_pos.vcf.gz
...
-Oz -o /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/qc_with_GT/panels/merged_sites_UKB_ELGH_Celline1kg_MAF0pt01_INFO_0pt9.vcf.gz
