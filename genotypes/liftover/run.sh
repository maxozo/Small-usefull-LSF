...
bcftools +fixref $vcf -Ov -o output3.vcf -- -d -f /lustre/scratch123/hgi/projects/ukbb_scrna/pipelines/Pilot_UKB/genotypes/onek1k/hg38/vcf/Homo_sapiens_assembly19.fasta -m flip-all
